...
void agregarElemento(listaDoble<Prenda>& listaPrendas, listaDoble<EstacionPrenda>& listaEstaciones) {
    ...
    switch (opcion) {
        case 1: {
            // Agregar prenda
            // Lógica para agregar una prenda a la listaPrendas
            break;
        }
        case 2: {
            // Agregar estación
            // Lógica para agregar una estación a la listaEstaciones
            break;
        }
        default: {
...
void eliminarElemento(listaDoble<Prenda>& listaPrendas, listaDoble<EstacionPrenda>& listaEstaciones) {
    ...
    switch (opcion) {
        case 1: {
            // Eliminar prenda
            // Lógica para eliminar una prenda de la listaPrendas
            break;
        }
        case 2: {
            // Eliminar estación
            // Lógica para eliminar una estación de la listaEstaciones
            break;
        }
        default: {
            cout << "Opcion invalida." << endl;
